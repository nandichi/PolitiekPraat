...
// Haal partijmeter data op uit de database
try {
    if ($debugMode) {
        echo "<!-- DEBUG: Probeer partijmeter data te laden -->\n";
    }
    ...
    if ($debugMode) {
        echo "<!-- DEBUG: PartijMeter data succesvol geladen -->\n";
        echo "<!-- DEBUG: Aantal vragen: $totalQuestions -->\n";
        echo "<!-- DEBUG: Aantal partijen: " . count($partijmeterData['parties']) . " -->\n";
        echo "<!-- DEBUG: Aantal party logos: " . count($partijmeterData['partyLogos']) . " -->\n";
        
        if (empty($partijmeterData['questions'])) {
    ...
    if ($debugMode) {
        echo "<!-- DEBUG: FOUT bij laden partijmeter data: " . $e->getMessage() . " -->\n";
...
$structuredData = [
    ...
    "@type" => "WebApplication",
    "name" => "PartijMeter 2025 Nederland",
    "description" => "Gratis online politieke test voor Nederlandse verkiezingen 2025. Ontdek welke politieke partij het beste bij jouw standpunten past.",
    "url" => URLROOT . "/partijmeter",
    ...
    "potentialAction" => [
        "@type" => "UseAction",
        "target" => URLROOT . "/partijmeter",
        "name" => "Start PartijMeter Test"
    ]
];
...
$faqStructuredData = [
    ...
    "mainEntity" => [
        [
            "@type" => "Question",
            "name" => "Hoe betrouwbaar is de PartijMeter test?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "Onze PartijMeter gebruikt officiële partijstandpunten uit verkiezingsprogramma's en recente uitspraken. Alle 14 Nederlandse politieke partijen zijn vertegenwoordigd met actuele standpunten over 30 thema's."
            ]
        ],
        [
            "@type" => "Question", 
            "name" => "Hoe lang duurt de PartijMeter test?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "De complete PartijMeter test duurt ongeveer 5-7 minuten. Je beantwoordt 30 stellingen over actuele politieke thema's en krijgt direct je persoonlijke resultaten met partij-matches."
            ]
        ],
        [
            "@type" => "Question",
            "name" => "Welke partijen zitten in de PartijMeter?", 
            "acceptedAnswer" => [
                "@type" => "Answer",
        ...
        [
            "@type" => "Question",
            "name" => "Is mijn PartijMeter data veilig?",
            "acceptedAnswer" => [
                "@type" => "Answer", 
...
$howToStructuredData = [
    "@context" => "https://schema.org",
    "@type" => "HowTo",
    "name" => "Hoe doe je de PartijMeter 2025 test",
    "description" => "Stap-voor-stap uitleg hoe je de Nederlandse PartijMeter 2025 test doet om jouw politieke match te vinden",
    "totalTime" => "PT7M",
    "supply" => [
        [
            "@type" => "HowToSupply",
...
<main class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-red-50">
    ...
    <div class="container mx-auto px-6 -mt-8 relative z-10">
        ...
        <!-- PartijMeter App Container -->
        <div id="partijmeter-app" class="max-w-6xl mx-auto pb-20" x-data="partijmeter()">
             ...
             <div class="max-w-5xl mx-auto mb-16">
                 ...
                 <div class="space-y-4" x-data="{ openFaq: 1 }">
                             ...
                             <div class="flex items-center justify-between">
                                 <div class="flex items-center space-x-4 flex-1">
                                     ...
                                     <h3 class="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">
                                         Hoe betrouwbaar is de PartijMeter test?
                                     </h3>
                                 </div>
                         ...
                         <div x-show="openFaq === 1" 
                             ...
                             <div class="px-6 md:px-8 pt-4 pb-6 md:pt-6 md:pb-8">
                                 <p class="text-gray-600 leading-relaxed text-base md:text-lg">
                                     Onze PartijMeter gebruikt officiële partijstandpunten uit verkiezingsprogramma's en recente uitspraken. 
                     ...
                     <div class="group bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden">
                         <button @click="openFaq = openFaq === 2 ? null : 2" 
                             ...
                             <div class="flex items-center justify-between">
                                 <div class="flex items-center space-x-4 flex-1">
                                     ...
                                     <h3 class="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">
                                         Hoe lang duurt de PartijMeter test?
                                     </h3>
                                 </div>
                                 <div class="flex-shrink-0 ml-4">
                                     <svg class="w-6 h-6 text-gray-500 transform transition-transform duration-300" 
                         ...
                         <div x-show="openFaq === 2" 
                             ...
                             <div class="px-6 md:px-8 pt-4 pb-6 md:pt-6 md:pb-8">
                                 <p class="text-gray-600 leading-relaxed text-base md:text-lg">
                                     De complete PartijMeter test duurt ongeveer 5-7 minuten. Je beantwoordt 30 stellingen over actuele 
                         ...
                         <button @click="openFaq = openFaq === 3 ? null : 3" 
                             ...
                             <div class="flex items-center justify-between">
                                 <div class="flex items-center space-x-4 flex-1">
                                     ...
                                     <h3 class="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">
                                         Welke partijen zitten in de PartijMeter?
                                     </h3>
                                 </div>
                                 <div class="flex-shrink-0 ml-4">
                                     <svg class="w-6 h-6 text-gray-500 transform transition-transform duration-300" 
                         ...
                         <div x-show="openFaq === 3" 
                             ...
                             <div class="px-6 md:px-8 pt-4 pb-6 md:pt-6 md:pb-8">
                                 <p class="text-gray-600 leading-relaxed text-base md:text-lg mb-6">
                                     Alle 14 grote Nederlandse politieke partijen zijn opgenomen in de PartijMeter 2025:
                                 </p>
                         ...
                         <button @click="openFaq = openFaq === 4 ? null : 4" 
                             ...
                             <div class="flex items-center justify-between">
                                 <div class="flex items-center space-x-4 flex-1">
                                     ...
                                     <h3 class="text-lg md:text-xl lg:text-2xl font-bold text-gray-800 group-hover:text-primary transition-colors duration-300">
                                         Is mijn PartijMeter data veilig?
                                     </h3>
                                 </div>
                                 <div class="flex-shrink-0 ml-4">
                                     <svg class="w-6 h-6 text-gray-500 transform transition-transform duration-300" 
                 ...
                 <div class="text-center mt-12 p-8 bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5 rounded-2xl border border-primary/10">
                     ...
                     <p class="text-gray-600 mb-6">
                         De beste manier om de PartijMeter te begrijpen is door hem uit te proberen
                     </p>
                     <a href="#partijmeter-app" 
...
function partijmeter() {
    return {
        ...
        questions: <?= json_encode($partijmeterData['questions'] ?? [], JSON_INVALID_UTF8_SUBSTITUTE) ?>,
        partyLogos: <?= json_encode($partijmeterData['partyLogos'] ?? [], JSON_INVALID_UTF8_SUBSTITUTE) ?>,
        dataLoaded: <?= !empty($partijmeterData['questions']) ? 'true' : 'false' ?>,
        ...
        init() {
            ...
            console.log('=== PARTIJMETER DEBUG INFO ===');
            ...
            if (!this.dataLoaded || this.questions.length === 0) {
                ...
                console.log('PartijMeter data geladen uit database:', this.questions.length, 'vragen');
        ...
        async loadDataFromAPI() {
            ...
            try {
                ...
                if (result.success && result.data) {
                    ...
                    console.log('PartijMeter data succesvol geladen uit API:', result.data);
                } else {
                    console.error('API response not successful:', result);
                    throw new Error('API response was not successful');
                }
            } catch (error) {
                console.error('Fout bij laden van partijmeter data:', error);
        ...
        shareResults() {
            ...
            const text = `Mijn PartijMeter 2025 resultaten:\n\n` +
            ...
            if (navigator.share) {
                navigator.share({
                    title: 'Mijn PartijMeter 2025 Resultaten',
                    text: text,
        ...
        shareResultsViaLink() {
            ...
            const topThree = this.finalResults.slice(0, 3);
            const text = `Bekijk mijn PartijMeter 2025 resultaten:\n\n` +
                `🥇 ${topThree[0]?.name}: ${topThree[0]?.agreement}%\n` +
                `🥈 ${topThree[1]?.name}: ${topThree[1]?.agreement}%\n` +
                `🥉 ${topThree[2]?.name}: ${topThree[2]?.agreement}%\n\n` +
                `Link: ${this.shareUrl}`;
