...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <!-- Tweede Kamer Reces Banner -->
    <?php 
    $recesInfo = $GLOBALS['recesInfo'] ?? ['inReces' => false];
    if ($recesInfo['inReces']): 
    ?>
    <div id="reces-banner" class="bg-gradient-to-r from-primary via-primary to-secondary text-white relative overflow-hidden z-10">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-2">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="font-bold text-lg">Tweede Kamer in <?php echo htmlspecialchars($recesInfo['naam']); ?></span>
                        </div>
                        
                        <div class="text-blue-100 text-sm">
                            Tot <?php echo htmlspecialchars($recesInfo['eindDatum']); ?>
                        </div>
                    </div>
                </div>
                
                <!-- Extra informatie voor desktop -->
                <div class="hidden md:flex items-center space-x-6 text-blue-100 text-sm">
                    <div class="flex items-center space-x-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C20.832 18.477 19.246 18 17.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                        <span>Meer analyses & opiniestukken</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <span>Minder blogs</span>
                    </div>
                </div>
            </div>
            
            <!-- Mobiele extra informatie -->
            <div class="md:hidden mt-3 pt-3 border-t border-blue-200/30">
                <div class="flex flex-col space-y-2 text-blue-100 text-sm">
                    <div class="flex items-center space-x-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C20.832 18.477 19.246 18 17.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                        <span>Tijdens het reces worden er meer diepgaande analyses en opiniestukken gepubliceerd</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <span>Dagelijkse politieke blogs komen minder frequent</span>
                    </div>
                </div>
            </div>
        </div>
