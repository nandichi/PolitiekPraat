        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="hidden md:flex items-center justify-between py-2.5">
                ...
                <div class="flex items-center space-x-3">
                    <div class="flex items-center space-x-2 bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm border border-white/30">
                        <div class="w-2 h-2 bg-white rounded-full animate-pulse"></div>
                        <span class="text-white font-bold text-sm uppercase tracking-wide">Breaking News</span>
                    </div>
                ...
                <div class="flex-1 mx-4 overflow-hidden">
                    <div class="animate-marquee whitespace-nowrap">
                        <a href="https://politiekpraat.nl/blogs/view/pvv-stapt-uit-de-coalitie-een-kritisch-overzicht-van-een-mislukt-experiment" 
                           class="text-white hover:text-yellow-200 transition-colors duration-300 font-semibold text-base">
                            🚨 KABINET SCHOOF-I GEVALLEN: PVV trekt zich terug uit coalitie na onenigheid over asielbeleid - Lees het volledige verhaal over dit politieke drama
                        </a>
                    </div>
                </div>
                ...
                <div>
                    <a href="https://politiekpraat.nl/blogs/view/pvv-stapt-uit-de-coalitie-een-kritisch-overzicht-van-een-mislukt-experiment" 
                       class="inline-flex items-center px-4 py-2 bg-white/20 border border-white/30 rounded-lg
                              text-white font-medium text-sm backdrop-blur-sm
                              hover:bg-white hover:text-red-600 transform hover:scale-105
