...
if (!function_exists('generateDynamicMetaDescription')) {
...
$cssAppPath = __DIR__ . '/../../public/css/app.build.css';
...
<html lang="nl">
<head>
    <!-- Theme bootstrap: voorkomt FOUC bij dark mode -->
    <script>
        (function () {
            try {
    ...
    <!-- Editorial typography: Fraunces (display) + Inter (UI) + JetBrains Mono (data) -->
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght,SOFT,WONK@9..144,300..900,0..100,0..1&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap">
