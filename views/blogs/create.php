        ...
        <div class="max-w-5xl mx-auto">
            ...
            <form action="<?php echo URLROOT; ?>/blogs/create" method="POST" enctype="multipart/form-data" 
                ...
                <div class="p-6 sm:p-10 relative">
                    ...
                    <!-- Poll Sectie -->
                    <div class="mt-8 bg-gradient-to-br from-secondary/5 via-white to-primary/5 border border-secondary/20 rounded-2xl p-6 md:p-8" data-aos="fade-up" data-aos-delay="340">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" id="enablePoll" class="sr-only peer">
                                <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-secondary/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-secondary"></div>
                                <span class="ml-3 text-sm font-medium text-gray-700">Poll inschakelen</span>
                            </label>
                        </div>

                        <!-- Poll Content (Hidden by default) -->
                        <div id="pollContent" class="hidden space-y-6">
                            <!-- Poll Vraag -->
                            <div>
                                ...
                                <input type="text" 
                                       name="poll_question" 
                                       id="pollQuestion" 
                                       class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none transition-all duration-300 bg-gray-50/50"
                                       placeholder="Bijvoorbeeld: Wat vind je van dit voorstel?">
                            </div>
                            ...
                            <div>
                                ...
                                <div id="pollOptions" class="space-y-3">
                                    <!-- Standaard 2 opties -->
                                    <div class="poll-option flex items-center gap-3">
                                        <span class="flex-shrink-0 w-8 h-8 bg-secondary/10 text-secondary rounded-full flex items-center justify-center text-sm font-medium">1</span>
                                        <input type="text" 
                                               name="poll_options[]" 
                                               class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none"
                                               placeholder="Optie 1">
                                        <button type="button" class="remove-option hidden text-red-500 hover:text-red-700 transition-colors">
                                    ...
                                    <div class="poll-option flex items-center gap-3">
                                        <span class="flex-shrink-0 w-8 h-8 bg-secondary/10 text-secondary rounded-full flex items-center justify-center text-sm font-medium">2</span>
                                        <input type="text" 
                                               name="poll_options[]" 
                                               class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none"
                                               placeholder="Optie 2">
                                ...
                                <button type="button" 
                                        id="addPollOption" 
                                        class="mt-3 inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors duration-300">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="poll_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none">
                                        <option value="single">Eén keuze</option>
                                ...
                                <div>
                                    ...
                                    <select name="poll_show_results" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none">
                                        <option value="after_vote">Na stemmen</option>
                                        <option value="always">Altijd zichtbaar</option>
                                        <option value="never">Nooit zichtbaar</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- Poll Description -->
                            <div>
                                <label for="pollDescription" class="block text-sm font-medium text-gray-700 mb-2">
                                    Beschrijving (optioneel)
                                </label>
                                <textarea name="poll_description" 
                                          id="pollDescription" 
                                          rows="2"
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none transition-all duration-300"
                                          placeholder="Extra uitleg over de poll..."></textarea>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Toggle poll content visibility
    enablePollCheckbox.addEventListener('change', function() {
        if (this.checked) {
            pollContent.classList.remove('hidden');
            pollContent.classList.add('animate-fadeIn');
        } else {
            pollContent.classList.add('hidden');
            pollContent.classList.remove('animate-fadeIn');
        }
    });

    // Add new poll option
    addPollOptionBtn.addEventListener('click', function() {
        const optionsCount = pollOptionsContainer.children.length;
        const newOptionNumber = optionsCount + 1;
        
        if (newOptionNumber <= 10) { // Max 10 opties
            const newOption = document.createElement('div');
            newOption.className = 'poll-option flex items-center gap-3';
            newOption.innerHTML = `
                <span class="flex-shrink-0 w-8 h-8 bg-secondary/10 text-secondary rounded-full flex items-center justify-center text-sm font-medium">${newOptionNumber}</span>
                <input type="text" 
                       name="poll_options[]" 
                       class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary/30 focus:border-secondary outline-none"
                       placeholder="Optie ${newOptionNumber}">
                <button type="button" class="remove-option text-red-500 hover:text-red-700 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                    </svg>
                </button>
            ...
            alert('Maximaal 10 poll opties toegestaan.');
        }
    });
    ...
    // Show/hide remove buttons based on option count
    function updateRemoveButtons() {
        const options = pollOptionsContainer.querySelectorAll('.poll-option');
        const removeButtons = pollOptionsContainer.querySelectorAll('.remove-option');
        
        if (options.length <= 2) {
            // Hide remove buttons if 2 or fewer options
