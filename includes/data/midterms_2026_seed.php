...
return [
    ...
    'timeline' => [
        ...
        [
            'event_date' => '2025-07-01', 'category' => 'event',
            'title_nl' => 'Strijd om het hertekenen van kiesdistricten',
            'description_nl' => 'In meerdere staten laaide een strijd op over het opnieuw indelen van kiesdistricten. Die herindelingen kunnen de uitgangspositie voor het Huis van Afgevaardigden flink beïnvloeden.',
            'source_url' => null,
        ],
        [
            'event_date' => '2025-11-04', 'category' => 'event',
            'title_nl' => 'Verkiezingen in het jaar voor de midterms',
            'description_nl' => 'Bij de off-year verkiezingen van 2025 kozen onder meer Virginia en New Jersey een nieuwe gouverneur. Analisten lazen de uitslagen als vroege graadmeter voor de stemming in het land.',
            'source_url' => null,
        ],
        [
            'event_date' => '2026-03-03', 'category' => 'primary',
            'title_nl' => 'Begin van het voorverkiezingsseizoen',
            'description_nl' => 'In het voorjaar van 2026 kiezen de partijen in tal van staten hun kandidaten. Begin maart valt een groot blok voorverkiezingen samen.',
            'source_url' => null,
        ],
        [
            'event_date' => '2026-06-02', 'category' => 'primary',
            'title_nl' => 'Zomer van de voorverkiezingen',
            'description_nl' => 'In de zomermaanden houden veel staten hun voorverkiezingen. Dan wordt duidelijk welke kandidaten het in november tegen elkaar opnemen.',
            'source_url' => null,
        ],
        [
